...
void test_add_multiple_nodes(TNode *root) {
  ...
  TEST("Nó 50 encontrado", node_50 != NULL && strcmp(node_50->data, "50") == 0);
  TNode *node_left_50 = node_50 != NULL ? node_50->left : NULL;
  TEST("Nó left 50: 30 encontrado", node_left_50 != NULL && strcmp(node_left_50->data, "30") == 0);
  TNode *node_right_50 = node_50 != NULL ? node_50->right : NULL;
  TEST("Nó right 50: Nó 70 encontrado", node_right_50 != NULL && strcmp(node_right_50->data, "70") == 0);
  printf("\n");
}
...
void test_search_existent_node(TNode *root) {
  ...
  TEST("Nó 60 encontrado", node_60 != NULL && strcmp(node_60->data, "60") == 0);
  printf("\n");
}
...
void test_remove_non_existent_node(TNode *root) {
  ...
  TNode *node_10 = search_node(root, "10");
  TEST("Nó 10 ainda existe", node_10 != NULL && strcmp(node_10->data, "10") == 0);
  printf("\n");
}
...
int main() {
  ...
  TNode *root = NULL;
  const char *data_values[] = {"50", "30", "70", "80", "20", "85", "40", "60", "90", "10", "35", "45", "65"};
  ...
  printf("\n");
  printf("Root after insertions: %s\n", root->data);
  printf("\n");
